...
public class PickupCamera : Photon.MonoBehaviour
{
	...
	private void SetUpRotation(Vector3 centerPos, Vector3 headPos)
	{
		...
		Ray ray = m_CameraTransformCamera.ViewportPointToRay(new Vector3(0.5f, 0.5f, 1f));
		Ray ray2 = m_CameraTransformCamera.ViewportPointToRay(new Vector3(0.5f, clampHeadPositionScreenSpace, 1f));
